...
setwd("/Volumes/gillandersw/Active/Project_0001_Clinical_Trials/pipeline_tests/hcc1395/pvactools_releases/7.0.0a14/plots")
dir()
...
percentiles_plot = compare_percentiles_plot(all_epitopes_standard_unique2, all_epitopes_normalized_unique2, "Median.MT.Percentile", x_label_p, y_label_p, "all alleles")
percentiles_plot = compare_percentiles_plot(all_epitopes_standard_unique2, all_epitopes_normalized_unique2, "Median.MT.IC50.Percentile", x_label_p, y_label_p, "all alleles")
percentiles_plot = compare_percentiles_plot(all_epitopes_standard_unique2, all_epitopes_normalized_unique2, "Median.MT.Immunogenicity.Percentile", x_label_p, y_label_p, "all alleles")
percentiles_plot = compare_percentiles_plot(all_epitopes_standard_unique2, all_epitopes_normalized_unique2, "Median.MT.Presentation.Percentile", x_label_p, y_label_p, "all alleles")
