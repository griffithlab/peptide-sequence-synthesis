...
if [[ $# -ne 4 ]]; then
  ...
  echo -e "\ne.g.\n\n./peptide-sequence-synthesis/scripts/pvacbind_commands/summarize_pvacbind_jobs.sh full_run_names_100Kpeptides_v7.0.0a8_first-1000-alleles.txt ./pvacbind_results/7.0.0a8 run_stats_100Kpeptides_v7.0.0a8_first-1000-alleles.tsv ./final_scores/7.0.0a8\n\n" >&2
  exit 1
fi
